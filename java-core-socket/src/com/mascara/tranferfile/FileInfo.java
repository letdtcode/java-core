...
public class FileInfo implements Serializable {
    ...
    public FileInfo(String destinationDirectory, String sourceDirectory, String fileName,
                    long fileSize, int piecesOfFile, int lastByteLength, byte[] dataBytes, String status) {
